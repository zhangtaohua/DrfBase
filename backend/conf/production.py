...
# ================================================= #
#小程序appid
TIKTOK_APPLET_APPID = "xxxxxxxxxxxxx"
#小程序秘钥
TIKTOK_APPLE_APPSECRET = "xxxxxxxxxxxxxxxxxx"

# ================================================= #
# ************** 微信小程序 配置  ************** #
# ================================================= #
#小程序appid
WX_APPLET_APPID = "xxxxxxxxxxxxxxxxxx"
#小程序秘钥
WX_APPLET_APPSECRET = "xxxxxxxxxxxxxxxxxxxxxx"
...
#微信公众平台申请的appid
WX_OFFICIAL_PLATFORM_APPID = "XXXXXXXXXXXXXX"
#微信公众平台申请的appsecret
WX_OFFICIAL_PLATFORM_APPSECRET = "XXXXXXXXXXXXXXXXXXXXXXXX"
...
#微信公众号appid
WX_OFFICIAL_ACCOUNT_APPID = "xxxxxxxxxxxxxxxxx"
#微信公众号秘钥
WX_OFFICIAL_ACCOUNT_APPSECRET = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
#微信公众号--服务器配置：服务器域名
WX_OFFICIAL_ACCOUNT_DOMAIN = "http://django-vue-lyadmin.lybbn.cn/"
#微信公众号--服务器配置：TOKEN
WX_OFFICIAL_ACCOUNT_TOKEN = "django-vue-lyadmin"
# #微信公众号——证书路径
# # WX_OFFICIAL_ACCOUNT_KEYSPATH = os.path.join(BASE_DIR, 'keys')
# # WX_OFFICIAL_ACCOUNT_MCH_CERT= os.path.join(WX_OFFICIAL_ACCOUNT_KEYSPATH, r"apiclient_cert.pem"),
# # WX_OFFICIAL_ACCOUNT_MCH_KEY= os.path.join(WX_OFFICIAL_ACCOUNT_KEYSPATH, r"apiclient_key.pem"),
