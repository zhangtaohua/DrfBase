    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, help_text='手机号', max_length=64, null=True, verbose_name='手机号')),
            ...
            managers=[
                ('objects', apps.v1.users.models.MyUserManager()),
            ],
        ),
    ]
